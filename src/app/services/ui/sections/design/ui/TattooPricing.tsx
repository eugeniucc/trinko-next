    ...
    <div className="grid grid-cols-1 gap-10 lg:gap-20 xl:grid-cols-2">
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-3xl font-bold md:text-4xl">Custom Tattoo Design</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-3xl font-bold md:text-4xl">Traditional Tattoo Design</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-3xl font-bold md:text-4xl">Modern Tattoo Design</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-3xl font-bold md:text-4xl">Geometric Tattoo Design</h2>
          <p className="text-gray-400">1–2 hours</p>
        </div>
