...
export const TattooPricing = () => {
  ...
  const pricingItems = t('servicesPage.sections.correction.pricing.items', { returnObjects: true }) as {
    title: string
    time: string
    price: string
    text?: string
    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
      {pricingItems.map((item, index) => (
        ...
        >
          ...
          <div className="flex h-full flex-col items-center justify-between gap-4 lg:items-start lg:text-left">
            <h3 className="text-center text-2xl font-bold text-gray-900 lg:text-left dark:text-white">{item.title}</h3>
