    ...
    <div className="grid grid-cols-1 gap-10 lg:gap-20 xl:grid-cols-2">
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-center text-3xl font-bold sm:text-start md:text-4xl">Faded Tattoo Restoration</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-center text-3xl font-bold sm:text-start md:text-4xl">Line Correction</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-center text-3xl font-bold sm:text-start md:text-4xl">Color Adjustment</h2>
      ...
      >
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <h2 className="text-center text-3xl font-bold sm:text-start md:text-4xl">Cover-Up Consultation</h2>
