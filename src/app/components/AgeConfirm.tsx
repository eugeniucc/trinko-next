...
export const AgeConfirm = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{isUnder ? 'Вам должно быть 18 лет' : 'Подтвердите возраст'}</DialogTitle>
          <DialogDescription>
            {isUnder ? 'Вы должны быть старше 18 лет, чтобы посетить этот сайт.' : 'Выберите, пожалуйста, свой возраст.'}
          </DialogDescription>
